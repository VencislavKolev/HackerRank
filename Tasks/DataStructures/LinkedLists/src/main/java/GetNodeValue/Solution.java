...
//        }
//        return map.get(count - positionFromTail).data;

        SinglyLinkedListNode pointer = llist;
        int counter = 0;
        // pointer starts walking when is exactly positionsFromTail positions from the head.
        // This means when head is at the end, pointer will be at positionsFromTail node.
        while (llist != null) {
            llist = llist.next;
